...
import com.hf.hf_smartcloud.http.Util;
        ...
        switch (resp.errCode) {
            case BaseResp.ErrCode.ERR_OK:
                if (resp instanceof SendAuth.Resp) {
                    ...
                    String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + Constants.APP_ID + "&secret=" + Constants.APP_SECRECT + "&code=" + code + "&grant_type=authorization_code";
    ...
    private class GetUserInfoTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                String unionid = jsonObject.optString("unionid");
                Log.i("result:::","openid:::"+openid+"nickname:::"+nickname+"sex:::"+sex+"language:::"+language+"city:::"+city+"province:::"+province+"country:::"+country+"headimgurl:::"+headimgurl+"unionid:::"+unionid);
                Toast.makeText(WXEntryActivity.this, "你好，" + nickname, Toast.LENGTH_SHORT).show();
                EventBus.getDefault().post(new MessageEvent(openid,nickname,sex,language,city,province,country,headimgurl,unionid));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
