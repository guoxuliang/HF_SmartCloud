...
public class SensorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SensorAdapter(List<String> datas, Context context, boolean hasMore) {
        // 初始化变量  
        this.datas = datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.sensor_item, null));
        } else {
