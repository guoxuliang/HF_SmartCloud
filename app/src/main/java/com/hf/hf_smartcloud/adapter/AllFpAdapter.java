...
public class AllFpAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AllFpAdapter(List<String> datas, Context context, boolean hasMore) {
        // 初始化变量  
        this.datas = datas;
    ...
    class NormalHolder extends RecyclerView.ViewHolder {
        View viewItem;
        TextView sb_name,sb_mac,sb_count,sb_date;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.allfp_item, null));
        } else {
