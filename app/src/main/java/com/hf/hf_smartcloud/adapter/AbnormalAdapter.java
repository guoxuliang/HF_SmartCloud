...
public class AbnormalAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AbnormalAdapter(List<String> datas, Context context, boolean hasMore) {
        // 初始化变量  
        this.datas = datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.item_ycxx_list, null));
        } else {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof NormalHolder) {
            ...
            ((NormalHolder) holder).tvdate.setText(datas.get(position));
            ((NormalHolder) holder).infoName.setText(datas.get(position));
            ((NormalHolder) holder).infoContent.setText(datas.get(position));
