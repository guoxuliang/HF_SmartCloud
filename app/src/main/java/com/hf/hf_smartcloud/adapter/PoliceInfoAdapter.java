...
public class PoliceInfoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PoliceInfoAdapter(List<String> datas, Context context, boolean hasMore) {
        // 初始化变量  
        this.datas = datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.item_bjxx_list, null));
        } else {
