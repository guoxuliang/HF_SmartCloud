...
public class RecycleViewBXAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private DevicesPortableDetailsActivity devicesPortableDetailsActivity;
    private List<String> list;

    public RecycleViewBXAdapter(DevicesPortableDetailsActivity devicesPortableDetailsActivity, List<String> list) {
        this.devicesPortableDetailsActivity = devicesPortableDetailsActivity;
        this.list = list;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(devicesPortableDetailsActivity).inflate(R.layout.item_recycle, parent, false);
