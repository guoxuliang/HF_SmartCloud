...
public class BillAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BillAdapter(List<String> datas, Context context, boolean hasMore) {
        // 初始化变量  
        this.datas = datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.bill_item, null));
        } else {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof NormalHolder) {
            ...
            ((NormalHolder) holder).name.setText(datas.get(position));
            ((NormalHolder) holder).time.setText(datas.get(position));
            ((NormalHolder) holder).total.setText(datas.get(position));
