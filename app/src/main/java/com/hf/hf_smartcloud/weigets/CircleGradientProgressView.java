...
//    private TextPaint mTextPaint;
    ...
    public CircleGradientProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        mCirclePadding = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,6,displayMetrics);
...
//    }
    ...
    /**
     * 如果自定义设置过{@link #()} 或通过xml设置过{@code app:labelText}则
