...
//    特殊刻度的宽度、特殊刻度的长度、时针的宽度、分针的宽度、秒针的宽度
    ...
    public NewClock(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context,AttributeSet attributeSet){
        ...
        mDefaultWidth=ta.getDimension(R.styleable.Clock_mDefaultWidth, SizeUtils.dp2px(context,5));
        mDefaultLength=ta.getDimension(R.styleable.Clock_mDefaultLength, SizeUtils.dp2px(context,8));
        mSpecialWidth=ta.getDimension(R.styleable.Clock_mSpecialWidth, SizeUtils.dp2px(context,5));
        mSpecialLength=ta.getDimension(R.styleable.Clock_mSpecialLength, SizeUtils.dp2px(context,30));
        mHWidth=ta.getDimension(R.styleable.Clock_mHWidth, SizeUtils.dp2px(context,4));
        ...
        mHColor=ta.getColor(R.styleable.Clock_mHColor, Color.RED);
...
//                canvas.translate(0, (-mClockRadius+mSpecialLength+mDefaultLength+mClockRingWidth));
                ...
                String text=i+"";
                mNumPaint.getTextBounds(text, 0, text.length(), textBound);
                canvas.rotate(-i*60); //因画布被旋转了，所以要把画布正过来再绘制数字
...
//        canvas.restore();
        //新时针
        canvas.save();
        mPointerPaint.setColor(this.getResources().getColor(R.color.black));
