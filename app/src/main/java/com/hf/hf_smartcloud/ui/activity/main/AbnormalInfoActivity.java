...
public class AbnormalInfoActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_abnormalinfo);
        initTitle();
        findView();
        initData();
        initRefreshLayout();
    ...
    private void findView() {
        swipebjxx = findViewById(R.id.swipeycxx);
        recyclerbjxx = findViewById(R.id.recyclerycxx);
        recyclerbjxx.addOnItemTouchListener(new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(AbnormalInfoActivity.this, "点击:" + position, Toast.LENGTH_LONG).show();
//                openActivity(AddaddressActivity.class);
            }

            @Override
            public void onLongClick(View view, int posotion) {
                Toast.makeText(AbnormalInfoActivity.this, "长按:" + posotion, Toast.LENGTH_LONG).show();
//                showPopMenu(view, posotion);
    ...
    private void initRecyclerView() {
        adapter = new AbnormalAdapter(getDatas(0, PAGE_COUNT), this, getDatas(0, PAGE_COUNT).size() > 0);
